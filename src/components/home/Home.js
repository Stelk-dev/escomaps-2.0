...
export default function Home() {
  ...
  return (
    <div>
      {/* Banners */}
      <div style={{height: 150, backgroundColor: 'red', margin: '32px'}}>
      </div>
      ...
      <div style={{padding: '0px 12px'}}>
        {/* Title positon */}
        <div>
          <h1 style={{fontWeight: 'bold', fontSize: '24px', marginBottom: '4px'}}>Escort in Milano</h1>
          <div style={{color: 'grey', fontSize: '14px'}}>Vuoi cercare nella tua zona? <a href='google.com' style={{color: 'red'}}>clicca qui</a></div>
        </div>
        <div style={{height: 36}} />
        
        {/* Filters */}
        <div>
          <h4 style={{marginBottom: '10px', fontWeight: '400'}}>Interessato in:</h4>
