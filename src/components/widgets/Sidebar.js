...
export default function Sidebar(props) {
    ...
    function SecondaryButton(props){
        return (
            <button className='secondary-buttons' onClick={() => props.onClick()}>
                ...
                <div style={{marginLeft: 8, display: 'flex', flexDirection: 'column', alignItems: 'start'}}>
                    ...
                    {/* Description */}
                    {
                        ...
                        (
                            <div style={{paddingTop: 3, fontSize: 12, color: 'grey'}}>{props.description}</div>
                        )
                    }
                </div>
            </button>
    ...
    return (
        <div>
            ...
            >
                <div style={{width: '68vw', backgroundColor: '#0d0c0c', height: '100vh', padding: '0px 8px', display: 'flex', flexDirection: 'column'}}>
                    {/* Title and close */}
                    ...
                    <div style={{width: '100%', height: '1px', backgroundColor: '#666666'}} />
                    <br />
                    
                    {/* Options */}
                    <SecondaryButton title="Lingua" description="Italiano" icon={<MdOutlineLanguage className='buttons-icons-secondary'/>} onClick={() => {}} />
                    <SecondaryButton title="Posizione" description="-" icon={<BiSolidMap className='buttons-icons-secondary'/>} onClick={() => {}} />
                    <SecondaryButton title="Domande frequenti" icon={<MdContactSupport className='buttons-icons-secondary'/>} onClick={() => {}} />
                    <SecondaryButton title="Contattaci" icon={<BiSolidMessageRoundedDetail className='buttons-icons-secondary'/>} onClick={() => {}} />
                    <SecondaryButton title="Termini e condizioni" icon={<IoDocuments className='buttons-icons-secondary'/>} onClick={() => {}} />
                </div>
            </SwipeableDrawer>
        </div>
    )
